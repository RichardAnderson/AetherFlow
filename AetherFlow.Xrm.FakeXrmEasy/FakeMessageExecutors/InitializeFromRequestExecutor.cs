...
namespace AetherFlow.Xrm.FakeXrmEasy.FakeMessageExecutors
{
    public class InitializeFromRequestExecutor : IFakeMessageExecutor
    {
        ...
        public OrganizationResponse Execute(OrganizationRequest request, XrmFakedContext ctx)
        {
            ...
            if (req == null)
                throw new FaultException<OrganizationServiceFault>(new OrganizationServiceFault(), new FaultReason("Cannot execute InitializeFromRequest without the request"));
