...
namespace AetherFlow.Xrm.FakeXrmEasy.FakeMessageExecutors
{
    public class ExecuteMultipleRequestExecutor : IFakeMessageExecutor
    {
        ...
        public OrganizationResponse Execute(OrganizationRequest request, XrmFakedContext ctx)
        {
            ...
            {
                throw new FaultException<OrganizationServiceFault>(new OrganizationServiceFault(), new FaultReason("You need to pass a value for 'Settings' in execute multiple request"));
            }

            if (executeMultipleRequest.Requests == null)
            {
                throw new FaultException<OrganizationServiceFault>(new OrganizationServiceFault(), new FaultReason("You need to pass a value for 'Requests' in execute multiple request"));
            }
